...
## Scope
This file defines repository-specific coding instructions for `glial-local-py`.

## Design Rules
- Prefer `@dataclass` for classes that primarily hold state.
- When a class is not a good dataclass candidate, keep it as a normal class and document that choice in code review notes or PR description.
